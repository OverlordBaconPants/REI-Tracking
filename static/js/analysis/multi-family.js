/**
 * multi-family.js
 * Multi-Family property strategy specific implementation
 */
...
const MultiFamilyHandler = {
  /**
   * Get the HTML template for Multi-Family analysis
...
getUnitTypesData() {
  ...
  populateFields(analysis) {
    ...
    UIHelpers.setFieldValue('property_type', 'Multi-Family'); // Should already be set and disabled
    UIHelpers.setFieldValue('square_footage', analysis.square_footage);
    UIHelpers.setFieldValue('lot_size', analysis.lot_size);
    UIHelpers.setFieldValue('year_built', analysis.year_built);
    UIHelpers.setFieldValue('total_units', analysis.total_units);
    UIHelpers.setFieldValue('occupied_units', analysis.occupied_units);
    UIHelpers.setFieldValue('floors', analysis.floors);
    ...
    // Set income fields
    UIHelpers.setFieldValue('other_income', analysis.other_income);
    UIHelpers.setFieldValue('total_potential_income', analysis.total_potential_income);
    ...
    UIHelpers.setFieldValue('common_area_maintenance', analysis.common_area_maintenance);
    UIHelpers.setFieldValue('elevator_maintenance', analysis.elevator_maintenance);
    UIHelpers.setFieldValue('staff_payroll', analysis.staff_payroll);
    UIHelpers.setFieldValue('trash_removal', analysis.trash_removal);
    UIHelpers.setFieldValue('common_utilities', analysis.common_utilities);
