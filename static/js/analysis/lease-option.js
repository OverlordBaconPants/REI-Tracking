...
const LeaseOptionHandler = {
  ...
  populateFields(analysis) {
    ...
    UIHelpers.setFieldValue('property_type', analysis.property_type);
    ...
    UIHelpers.setFieldValue('bedrooms', analysis.bedrooms);
    UIHelpers.setFieldValue('bathrooms', analysis.bathrooms);
    
    // Set lease option details
    UIHelpers.setFieldValue('purchase_price', analysis.purchase_price);
    UIHelpers.setFieldValue('strike_price', analysis.strike_price);
    UIHelpers.setFieldValue('option_consideration_fee', analysis.option_consideration_fee);
    UIHelpers.setFieldValue('option_term_months', analysis.option_term_months);
    
    // Set rental income details
    UIHelpers.setFieldValue('monthly_rent', analysis.monthly_rent);
    UIHelpers.setFieldValue('monthly_rent_credit_percentage', analysis.monthly_rent_credit_percentage);
    UIHelpers.setFieldValue('rent_credit_cap', analysis.rent_credit_cap);
