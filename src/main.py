...
def init_dashboards():
    ...
    try:
        ...
        from src.dash_apps.dash_kpi import create_kpi_dash
        ...
        # Create and attach KPI dashboard
        app.kpi_dash = create_kpi_dash(app)
        app_logger.info("KPI dashboard initialized successfully")
