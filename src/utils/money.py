...
class Money:
    ...
    This class provides proper decimal handling for monetary values,
    ensuring accurate calculations and consistent formatting.
    
    Args:
        amount: The monetary amount as a number, string, or another Money object
    ...
    def __add__(self, other):
        ...
        if hasattr(other, 'as_decimal'):  # Handle Percentage objects
            # When adding a percentage, add the percentage of self to self
            return Money(self.amount + (self.amount * other.as_decimal()))
...
class Percentage:
    ...
    This class provides proper decimal handling for percentage values,
    ensuring accurate calculations and consistent formatting.
    
    Args:
        value: The percentage value as a number, string, or another Percentage object
...
class MonthlyPayment:
    ...
    This class provides a structured way to represent monthly loan payments,
    with separate tracking of principal and interest components.
